...
<img src="{$cashfree_tracking|escape:'htmlall':'UTF-8'}" alt="" style="display: none;"/>
	...
	<form action="{$cashfree_form|escape:'htmlall':'UTF-8'}" id="module_form" class="defaultForm form-horizontal" method="post">
...
<div class="form-group">              
				...
				<label class="control-label col-lg-3" for="cashfree_secret_key">{l s='Secret Key:' mod='cashfree'}</label>
<div class="col-lg-3">
<div class="input-group">
...
<div class="form-group">                    
				<label class="control-label col-lg-3" for="cashfree_order_status">{l s='Success Order Status:' mod='cashfree'}</label>                                
<div class="col-lg-3">
