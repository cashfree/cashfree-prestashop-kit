...
<div class="conf confirmation">
	{l s='Congratulations! Your order has been saved under' mod='cashfree'}{if isset($cashfree_order.reference)} {l s='the reference' mod='cashfree'} <b>{$cashfree_order.reference|escape:html:'UTF-8'}</b>{else} {l s='the ID' mod='cashfree'} <b>{$cashfree_order.id|escape:html:'UTF-8'}</b>{/if}.
</div>
{else}
<div class="error">
