...
class Cashfree extends PaymentModule
{
    ...
    public function hookPaymentReturn($params)
    {
        ...
        return $this->display(dirname(__FILE__), '/views/templates/front/order-confirmation.tpl');
    }
    ...
    public function hookOrderConfirmation($params)
    {
        ...
        $errmsg = '';
        if (Tools::getIsset(Tools::getValue('errmsg'))) $errmsg = base64_decode(Tools::getValue('errmsg'));
    ...
    public function cashfreeExternalPaymentOption()
    {
        ...
        $newOption->setCallToActionText($this->l('Pay with Cashfree'))
            ->setAction($url)
            ->setAdditionalInformation($this->context->smarty->fetch('module:cashfree/views/templates/front/payment_infos.tpl'));
